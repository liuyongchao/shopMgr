...
window.layui.define('layer', function(exports){
 ...
 // SHOW = 'layui-show', 
  ...
  Form.prototype.render = function(type){
      ...
      select: function(){
        ...
        events = function(reElem, disabled){
          ...
          reElem.find('dl>dd').on('click', function(){
            ...
            window.layui.event(MOD_NAME, 'select('+ filter +')', {
              elem: select[0],
              value: value
            });
          });
        ...
        selects.each(function(index, select){
          ...
          var reElem = $(['<div class="layui-unselect '+ CLASS + (disabled ? ' layui-select-disabled' : '') +'">',
            ...
            '<dl class="layui-anim layui-anim-upbit'+ (othis.find('optgroup')[0] ? ' layui-select-group' : '') +'">'+ function(options){
              var arr = [];
              window.layui.each(options, function(index, item){
        ...
        events = function(reElem, RE_CLASS){
          ...
          reElem.on('click', function(){
            ...
            check[0].checked ? (
              ...
              window.layui.event(MOD_NAME, RE_CLASS[2]+'('+ filter +')', {
              elem: check[0],
              value: check[0].value
            });
          });
      ...
      radio: function(){
        ...
        events = function(reElem){
          ...
          reElem.on('click', function(){
            ...
            window.layui.each(sameRadio, function(){
            ...
            window.layui.event(MOD_NAME, 'radio('+ filter +')', {
              elem: radio[0],
              value: radio[0].value
            });
          });
    ...
    ) : window.layui.each(items, function(index, item){
      item();
    });
    return that;
  };
  ...
  var submit = function(){
    ...
    //开始校验
    window.layui.each(verifyElem, function(_, item){
    ...
    window.layui.each(fieldElem, function(_, item){
      if(!item.name) return;
    ...
    //获取字段
    return window.layui.event.call(this, MOD_NAME, 'submit('+ filter +')', {
      elem: this,
      form: formElem,
      field: field
    });
