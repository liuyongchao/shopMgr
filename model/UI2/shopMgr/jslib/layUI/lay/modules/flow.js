  ...
  Flow.prototype.lazyimg = function(options){
    ...
    var show = function(item, height){
      ...
      if(othis){
    	...
    	var  load=function(lazyimgElem){
    	   var item = lazyimgElem.eq(i), 
    	       elemTop = notDocment ? function(){return item.offset().top - scrollElem.offset().top + start;}() : item.offset().top;    
           show(item, height);
           index = i; 
