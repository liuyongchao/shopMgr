...
window.layui.define('jquery', function(exports){
  "use strict";
  
  var $ = window.layui.jquery,
 // hint = window.layui.hint(),
  device = window.layui.device(),
  ...
  Element.prototype.on = function(events, callback){
    return window.layui.onevent(MOD_NAME, events, callback);
  };
  
  //外部Tab新增
  Element.prototype.tabAdd = function(filter, options){
    var tabElem = $('.layui-tab[lay-filter='+ filter +']'),titElem = tabElem.children('.layui-tab-title'),contElem = tabElem.children('.layui-tab-content');
  ...
  Element.prototype.tabDelete = function(filter, index){
    var tabElem = $('.layui-tab[lay-filter='+ filter +']'),liElem = tabElem.children('.layui-tab-title').find('>li').eq(index);
  ...
  var NAV_ELEM = '.layui-nav', NAV_ITEM = 'layui-nav-item', NAV_BAR = 'layui-nav-bar',NAV_TREE = 'layui-nav-tree', NAV_CHILD = 'layui-nav-child', NAV_MORE = 'layui-nav-more',NAV_ANIM = 'layui-anim layui-anim-upbit';
  ...
  var call = {
    ...
    tabClick: function(e, index, liElem){
      ...
      var  parents = othis.parents('.layui-tab'),
      ...
      window.layui.event.call(this, MOD_NAME, 'tab('+ filter +')', {
        elem: parents,
        index: index
      });
    },
   ...
   //   var SCROLL = 'layui-tab-scroll',
    ...
    clickThis: function(){
      ...
      othis.addClass(THIS);
      window.layui.event.call(this, MOD_NAME, 'nav('+ filter +')', othis);
    },
    //点击子菜单选中
    clickChild: function(){
  ...
  Element.prototype.init = function(type){
   // var that = this, 
    ...
    return window.layui.each(items, function(index, item){
      item();
    });
  };
